      ...
      list: [
        {
          ...
          price: '$ 350',
          quantity: '5',
          img: process.env.BASE_URL + 'assets/media/stock-600x400/img-1.jpg',
        },
        {
          title: 'SmartCleaner',
          ...
          price: '$ 650',
          quantity: '4',
          img: process.env.BASE_URL + 'assets/media/stock-600x400/img-2.jpg',
        },
        {
          title: 'CameraX',
          ...
          price: '$ 150',
          quantity: '3',
          img: process.env.BASE_URL + 'assets/media/stock-600x400/img-3.jpg',
        },
        {
          title: '3DPrinted',
          ...
          price: '$ 1450',
          quantity: '7',
          img: process.env.BASE_URL + 'assets/media/stock-600x400/img-4.jpg',
        },
      ],
    }
  },
